...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://cheffy-api.thystreet.com/api/v1
         */
        this.basePath = 'https://cheffy-api.thystreet.com/api/v1'.replace(/\/+$/, '');
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'ThyStreet/0.0.1/javascript'
        };
